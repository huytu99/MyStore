...
class AdapterLaptop (private val listPhone:ArrayList<Model>) : RecyclerView.Adapter<AdapterLaptop.MyViewHolder> (){
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView= LayoutInflater.from(parent.context).inflate(R.layout.laptop_list,parent,false)
...
//        holder.hangton.text=item.hangton
        ...
        holder.itemView.setOnClickListener {
            val i = Intent(it.context, DetailItem::class.java)
